...
Database schema is available at link:specs directory.
...
* If you want to see sime dummy blog posts in the application, run:
...
* Run <tt>rails server</tt> and go to http://localhost:3000/
...
* create rake task for setting up blog (instead of renaming bunch of files, as
  described in README)
